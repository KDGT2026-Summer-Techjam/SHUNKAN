...
> MVPは個人利用です。共有、公開、共同編集、SNS連携、通知は対象外です。写真はSHUNKAN-log（MomentLog）に紐付け、JPEG / PNG / WebP / GIF形式、1枚10MB以下、SHUNKAN-log 1件あたり最大3枚とします。保存時は元の縦横比を保って長辺1920px以下へ縮小・最適化し、アルバムではすべての写真を正方形にトリミング表示します。GIFアニメーションは維持します。詳細は[要件定義](docs/07-要件定義.md)を確認してください。
