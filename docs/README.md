...
旬間 (SHUNKAN) は、自分で決めた今だけの期間をルームとして作り、やりたいこと・達成したこと・残り時間・写真を振り返れる Web アプリです。最初のデモでは「2026 夏」と「TechJam 2026」ルームを使います。
...
### [08-ルーム中心設計.md](08-ルーム中心設計.md)

講師相談を受けて決めた、ルーム中心のプロダクト構造、テーブルの関係、画面遷移、実装を分けるブランチの順序を確認する資料です。
